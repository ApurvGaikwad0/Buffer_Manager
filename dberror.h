...
#define RC_POOL_NOT_INIT 400
#define RC_PAGE_NOT_FOUND 401
#define RC_NEGATIVE_PAGE_NUM 402
#define RC_MEMORY_ALLOCATION_ERROR 403
#define RC_NO_AVAILABLE_FRAME 404
#define RC_PAGE_NOT_PINNED 405
